...
```
This dataset describes the species, island, bill size (depth and length), flipper length, body mass, sex, and year catalogued of penguins. There are 344 entries (rows) to the dataset and 8 variables (columns). The average flipper length amongst the penguins is 200.92.
...
Prob2_df = tibble(
  x = rnorm(10),
  x_pos = x > 0,
  description = c("bubbly", "mighty", "quaint", "barbarious", "barbarious", "bubbly", "mighty", "mighty", "bubbly", "quaint"), ##change to different words
